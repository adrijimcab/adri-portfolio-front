      ...
      <div class="mx-auto max-w-6xl">
        ...
        @if (!repos()) {
                  ...
                  <app-glass-card>
                    <div class="flex items-start justify-between gap-2">
                      ...
                      @if (repo.is_pinned) {
                        ...
                        >
                          <path
                            d="M4.456.734a1.75 1.75 0 012.826.504l.613 1.327a3.08 3.08 0 002.084 1.707l2.454.584c1.332.317 1.8 1.972.832 2.94L11.06 10l3.72 3.72a.749.749 0 01-1.06 1.06L10 11.06l-2.204 2.205c-.968.968-2.623.5-2.94-.832l-.584-2.454a3.08 3.08 0 00-1.707-2.084l-1.327-.613a1.75 1.75 0 01-.504-2.826L4.456.734z"
                          />
                        </svg>
                      }
                    </div>
          ...
          <div class="mt-8 text-center" appScrollAnimate>
            <a
              href="https://github.com/adrijimcab"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Ver todos los repositorios en GitHub (abre en nueva ventana)"
