...
@Component({
  ...
  template: `
    <nav
      class="fixed top-0 z-50 w-full border-b border-white/[0.06] transition-all duration-300"
      [class]="scrolled() ? 'bg-black/80 backdrop-blur-xl' : 'bg-transparent'"
    >
      <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <a [routerLink]="['/', lang()]" class="text-lg font-bold text-white">
        ...
        <div class="hidden items-center gap-6 md:flex">
          ...
          >
          <a
            [routerLink]="['/', lang(), 'guestbook']"
            routerLinkActive="text-white"
            class="text-sm text-white/60 transition-colors hover:text-white"
            >Guestbook</a
          >
          <a
            [routerLink]="['/', lang(), 'battle']"
            routerLinkActive="text-white"
            class="text-sm text-white/60 transition-colors hover:text-white"
            >{{ t.t('nav.battle') }}</a
          >
          <a
            [routerLink]="['/', lang(), 'services']"
            routerLinkActive="text-white"
            class="text-sm text-white/60 transition-colors hover:text-white"
            >{{ t.t('nav.services') }}</a
          >
...
export class NavbarComponent {
  ...
  readonly lang = computed(() => this.t.currentLang());
